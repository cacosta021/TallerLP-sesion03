...
from .forms import ArticuloForm, ListaPrecioForm  # Asegúrate de tener estos formularios
...
def home(request):
    ...
    context = {
        ...
        'ventas_hoy': 0,  # Aquí podrías calcular las ventas del día si lo implementas
    }
